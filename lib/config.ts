...
function createDefaultConfig(): void {
    ...
    const configContent = [
        ...
        "    // ============================================================",
        '    "commands": {',
        '        "enabled": true,                    // 启用 DCP 斜杠命令',
        '        "protectedTools": [],               // 保护的工具名，其输出不会被 /dcp-sweep 清理',
        "    },",
        "",
        "    // ============================================================",
        "    // 手动模式",
        "    // ============================================================",
        '    "manualMode": {',
        '        "enabled": false,                   // 启用后不自动注入压缩提醒',
        '        "automaticStrategies": true,        // 手动模式下继续运行去重和错误清理',
        "    },",
        "",
        "    // ============================================================",
        "    // 轮次保护",
        ...
        "    // ============================================================",
        '    "experimental": {',
        '        "allowSubAgents": false,            // 允许在子代理会话中压缩上下文',
        '        "customPrompts": false,             // 允许自定义 DCP 提示词',
        "    },",
        "",
        '    "protectedFilePatterns": [],             // 保护文件操作不被裁剪（glob 模式）',
        "",
        "    // ============================================================",
        ...
        '    "strategies": {',
        '        "deduplication": {',
        '            "enabled": true,                // 去重：相同工具名+参数只保留最新结果',
        '            "protectedTools": [],           // 排除的工具名',
        "        },",
        '        "purgeErrors": {',
        '            "enabled": true,                // 错误清理：报错工具过 N 轮后清除输入',
        '            "turns": 4,                     // 保留轮数',
        '            "protectedTools": [],           // 排除的工具名',
        "        },",
        "    },",
