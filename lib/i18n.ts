...
const zh: Record<string, string> = {
    ...
    "Replace completed conversation with summary card": "将已完成对话替换为总结卡片",
    ...
    "DCP: Purge Notification": "DCP：彻底清理通知",
    Compression: "压缩",
    Purge: "彻底清理",
    removed: "移除",
    summary: "摘要",
    ...
    "and {n} tools purged": "和 {n} 个工具已彻底清理",
    "{n} ranges purged": "{n} 个片段已彻底清理",
    compressed: "已压缩",
    purged: "已彻底清理",
    "→ Compression": "→ 压缩",
    "→ Purge": "→ 彻底清理",
